...
//        };
        ...
        return args -> {
            addUser("user1", "password1", "USER", "FirstName1", "LastName1", new Date(), "Street 1", "City 1", "10001", 1L);
            addUser("user2", "password2", "USER", "FirstName2", "LastName2", new Date(), "Street 2", "City 2", "10002", 1L);
            addUser("user3", "password3", "USER", "FirstName3", "LastName3", new Date(), "Street 3", "City 3", "10003", 2L);
            addUser("user4", "password4", "USER", "FirstName4", "LastName4", new Date(), "Street 4", "City 4", "10004", 2L);
            addUser("user5", "password5", "USER", "FirstName5", "LastName5", new Date(), "Street 5", "City 5", "10005", 3L);
            addUser("user6", "password6", "USER", "FirstName6", "LastName6", new Date(), "Street 6", "City 6", "10006", 3L);
            addUser("user7", "password7", "USER", "FirstName7", "LastName7", new Date(), "Street 7", "City 7", "10007", 4L);
            addUser("user8", "password8", "USER", "FirstName8", "LastName8", new Date(), "Street 8", "City 8", "10008", 4L);
            addUser("user9", "password9", "USER", "FirstName9", "LastName9", new Date(), "Street 9", "City 9", "10009", 5L);
            addUser("user10", "password10", "USER", "FirstName10", "LastName10", new Date(), "Street 10", "City 10", "10010", 5L);
        };
